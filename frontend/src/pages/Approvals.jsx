...
const Approvals = () => {
    ...
    const handleApprove = async (id) => {
        try {
            await fetch(`http://localhost:8000/api/approvals/${id}/approve`, { method: 'POST' });
    ...
    return (
        <div className="space-y-6">
            <header className="mb-8">
                <h1 className="text-3xl font-bold text-white tracking-tight mb-1">Approval Queue</h1>
                <p className="text-gray-400">Review content generated by the Swarm before progression.</p>
            </header>
                    ...
                    <Card key={item.id} className="flex flex-col h-full border-t-4 border-t-cyan-500 relative">
                        ...
                        <div className="grid grid-cols-2 gap-2 mt-auto">
                            ...
                            <Button
                                ...
                                className="flex justify-center items-center gap-1 group border-emerald-500/30 text-emerald-400 hover:bg-emerald-900/20 bg-emerald-900/10"
                            >
                                <Check className="w-4 h-4 group-hover:scale-110 transition-transform" />
                                <span className="hidden sm:inline text-xs">{item.type === 'Script' ? 'Approve' : 'Answer in Popup'}</span>
                            </Button>
                        </div>
                    ...
                    <div className="bg-navy-900 border border-cyan-900/50 rounded-xl p-6 max-w-2xl w-full shadow-2xl relative max-h-[90vh] flex flex-col">
                        ...
                        <div className="flex-1 overflow-y-auto custom-scrollbar pr-2 mb-4 space-y-4">
                            <div className="bg-navy-800/50 p-4 rounded-lg border border-gray-800">
                                <h3 className="text-sm font-semibold text-cyan-400 mb-1">Context</h3>
                            ...
                            {selectedItem.script && (
                                <div>
                                    <h3 className="font-semibold text-cyan-400 mb-2 uppercase text-xs tracking-wider">Generated Script</h3>
